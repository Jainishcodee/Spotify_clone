...
import 'package:get/get.dart';
import 'local_notification_service.dart'; // You already created this
...
class Notify extends GetxController {
  ...
  void setupAudioPlayer() {
    // Set player to stop when done playing
    audioPlayer.setReleaseMode(ReleaseMode.stop);

    // Update isIconPlay based on player state and show notifications
    audioPlayer.onPlayerStateChanged.listen((PlayerState state) {
      isIconPlay.value = state == PlayerState.playing;
      if (isIconPlay.value) {
